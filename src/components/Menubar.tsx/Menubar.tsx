...
function Menubar({ControlCenter}:onClickProps) {
  return (
    <div className="relative flex items-center justify-center w-full h-auto p-2">
        <div className="absolute right-5 top-[50%] flex items-center justify-center w-auto bg-black/10 rounded-xl">
        ...
        <div className="absolute left-5 top-[50%] flex items-center justify-center pr-3 w-auto bg-black/10 rounded-xl">
