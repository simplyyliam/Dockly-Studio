...
function Menubar({ControlCenter, Wallpapers}:onClickProps) {
  return (
    <div className="relative flex items-center justify-center w-full h-auto p-2">
        <div className="absolute right-0 top-[50%] flex items-center justify-center w-auto bg-black/10 backdrop-blur-md border-1 border-stone-200/25 rounded-xl scale-85">
        ...
        <div className="absolute left-0 top-[50%] flex items-center justify-center pr-3 w-auto bg-black/10 backdrop-blur-md border-1 border-stone-200/25 rounded-xl scale-85">
